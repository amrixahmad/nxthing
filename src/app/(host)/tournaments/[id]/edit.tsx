...
import { toDMY, toHM12, combineDateTime, parseDMY, parseTime12 } from "@/src/utils/datetime";
...
export default function EditTournament() {
  ...
  // Date picker state (web calendar)
  ...
  function openCalendar(target: "start" | "end" | "regStart" | "regEnd") {
    ...
    const v = target === "start" ? startDate : target === "end" ? endDate : target === "regStart" ? regStart : regEnd;
  ...
  function handleTimePick(target: "start" | "end" | "regStart" | "regEnd") {
    if (Platform.OS === "web") {
      ...
      if (parsed) {
        let h12 = parsed.hours24 % 12; if (h12 === 0) h12 = 12;
        setTimeHour(h12);
  ...
  return (
    <ScrollView className="flex-1 bg-gray-50">
      ...
      {showPicker && Platform.OS !== "web" && (
        <DateTimePicker value={pickerDate} mode="date" display="default" onChange={onNativeChange} />
      )}
      {showTimePicker && Platform.OS !== "web" && (
        <DateTimePicker value={timePickerDate} mode="time" display="default" onChange={onNativeTimeChange} />
      )}
